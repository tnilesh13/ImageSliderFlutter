...
//   // var myNewList;
//   late List<Map<String, String>> myNewList;
...
//         Sliders mySlider = Sliders.fromJson(value['Sliders']);

//         List<Widget> itemWidgets = [];
//         for (SliderItems item in mySlider.items!) {
//           if(item.sliderType == "Image") {
//             itemWidgets.add(DImage1(item));
//           } else if (item.sliderType == "ImageWithText") {
//             DImageWithText(item);
//           } else {
//             DImageWithTextButton(item);
//           }
//         }
//     return Scaffold(
//         appBar: AppBar(
...
//                       //     print('SliderType${val['SliderType']}');
//                       //     print('SliderText${val['SliderText']}');
//                       //     print('SliderLink${val['SliderLink']}');
//                       //     print('SliderButtonText${val['SliderButtonText']}');
//                       //     print('SliderButtonColor${val['SliderButtonColor']}');
//                       //     print('SliderBackgroundColor${val['SliderBackgroundColor']}');
//                       //     print('SliderBannerType${val['SliderBannerType']}');
//                       //     print('SliderBannerUID${val['SliderBannerUID']}');
//                       //     print("------------------------");
//                       //     print("------------------------");
